...
export default defineConfig([
  // `dist-engine/` is the esbuild output for the embedded CLI engine
  // bundle. It's regenerated by `npm run build:engine` and shipped
  // into the CLI binary via include_str!, never hand-edited. Ignoring
  // keeps lint runs from flagging the minified output.
